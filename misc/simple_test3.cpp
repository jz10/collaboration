...
int test_onemkl(unsigned long hDriver, unsigned long hDevice, unsigned long hContext,
  ...
  sycl::queue queue = sycl::level_zero::make<sycl::queue>(sycl_context,
...
int main(int argc, char* argv[]) {
  ...
  my_errno= zeCommandQueueCreate(hContext, hDevice, &cqDesc, &hQueue);
  check_error(my_errno, "zeCommandQueueCreate");
